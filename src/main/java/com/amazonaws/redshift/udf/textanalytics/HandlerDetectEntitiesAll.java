...
public class HandlerDetectEntitiesAll implements RequestHandler<Object, String>{
    ...
    public String handleRequest(Object event, Context context)
    {
        ...
        try {
            ...
            String[] output = textAnalyticsUDFHandler.detect_entities_all(input, languageCodes);
            redshiftUDFResponse.setResults(output);
        } 
        catch (Exception e) {
            System.out.println("ERROR: detect_entities_all Exception\n" + e);
