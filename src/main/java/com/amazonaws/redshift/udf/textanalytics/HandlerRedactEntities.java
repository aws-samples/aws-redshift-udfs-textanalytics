...
public class HandlerRedactEntities implements RequestHandler<Object, String>{
    ...
    public String handleRequest(Object event, Context context)
    {
        ...
        try {
            ...
            String[] output = textAnalyticsUDFHandler.redact_entities(input, languageCodes, redactTypesArray);
            redshiftUDFResponse.setResults(output);
        } 
        catch (Exception e) {
            System.out.println("ERROR: redact_entities Exception\n" + e);
