...
public class HandlerDetectEntities implements RequestHandler<Object, String>{
    ...
    public String handleRequest(Object event, Context context)
    {
        ...
        try {
            ...
            String[] output = textAnalyticsUDFHandler.detect_entities(input, languageCodes);
            redshiftUDFResponse.setResults(output);
        } 
        catch (Exception e) {
            System.out.println("ERROR: detect_entities Exception\n" + e);
