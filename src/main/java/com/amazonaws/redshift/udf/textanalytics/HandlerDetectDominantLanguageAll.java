...
public class HandlerDetectDominantLanguageAll implements RequestHandler<Object, String>{
    ...
    public String handleRequest(Object event, Context context)
    {
        ...
        try {
            ...
            String[] output = textAnalyticsUDFHandler.detect_dominant_language_all(input);
            redshiftUDFResponse.setResults(output);
        } 
        catch (Exception e) {
            System.out.println("ERROR: detect_dominant_language_all Exception\n" + e);
